...
# Prompt
task = """
I made a fake dataset containing feedback from employees at a company conserning their IT services.
...
"""
structured_llm = LlmRes.llm.with_structured_output(Categorize)
...
with open("./prompting/output_df.txt", "w") as ofile:
